...
async function build() {
  ...
  return {
    ...
    stats: {
      /* Which deploy produced this. Netlify injects these at build time. Without
       * them, a report from a stale deploy is indistinguishable from a fix that
       * did not work — which cost a debugging round trip. */
